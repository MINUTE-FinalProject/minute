      ...
      <main className={bookmarkStyle.mainContent}>
        <header className={bookmarkStyle.header}>
          ...
          <div className={bookmarkStyle.buttons}>
            ...
            <button className={bookmarkStyle.btn} onClick={handleDeleteFolder}>
              삭제
            </button>
          </div>
        </header>
          ...
          <div className={bookmarkStyle.modalOverlay}>
            <div className={bookmarkStyle.modalContent}>
              ...
              <div className={bookmarkStyle.modalButtons}>
                <button onClick={handleAddModalSubmit} className={bookmarkStyle.btn}>
                  확인
                </button>
                <button onClick={handleAddModalCancel} className={bookmarkStyle.btn}>
                  취소
                </button>
              </div>
            </div>
        ...
        {isRenameModalOpen && (
          <div className={bookmarkStyle.modalOverlay}>
            <div className={bookmarkStyle.modalContent}>
              ...
              />
              <div className={bookmarkStyle.modalButtons}>
                <button onClick={handleRenameModalSubmit} className={bookmarkStyle.btn}>
                  확인
                </button>
                <button onClick={handleRenameModalCancel} className={bookmarkStyle.btn}>
                  취소
                </button>
              </div>
            </div>
        ...
        {isDeleteModalOpen && (
          <div className={bookmarkStyle.modalOverlay}>
            <div className={bookmarkStyle.modalContent}>
              ...
              <div className={bookmarkStyle.modalButtons}>
                <button onClick={handleDeleteModalSubmit} className={bookmarkStyle.btn}>
                  확인
                </button>
                <button onClick={handleDeleteModalCancel} className={bookmarkStyle.btn}>
                  취소
                </button>
              </div>
            </div>
